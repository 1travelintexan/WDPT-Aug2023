...
// console.log(people[3][2]);

// console.log(people[4].age);
...
// console.log(person.studies.degree);
...
// console.log(schoolSystem.schools[0].classRooms[0].students[2].age);
console.log(schoolSystem.schools[2].classRooms[1].teacher.lastName);
